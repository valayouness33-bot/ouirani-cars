      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-4">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
              ...
              <span className="text-orange-400">votre confort</span>
            </h2>
          </div>
          <Button
            asChild
            variant="outline"
            className="border-orange-500/40 text-orange-400 hover:bg-orange-500/10 hover:text-orange-300 shrink-0"
          >
            <Link href="/voitures">
        ...
        <div className="space-y-5">
          {cars.map((car, i) => (
            <div
              key={car.id}
              className={`group relative rounded-2xl overflow-hidden border border-white/5 hover:border-orange-500/30 transition-all duration-300 hover:shadow-[0_0_50px_-15px_rgba(249,115,22,0.25)] ${
                ...
                <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
                  <div>
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                      ...
                      <div className="flex items-center gap-1.5 bg-green-500/10 border border-green-500/20 rounded-full px-3 py-1.5 shrink-0">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 mb-5">
                      <div className="flex items-center gap-2 text-sm text-gray-400">
                        <Users className="h-4 w-4 text-orange-400/70" />{car.seats} places
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-400">
                        <Gauge className="h-4 w-4 text-orange-400/70" />{car.transmission}
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-400">
                        <Fuel className="h-4 w-4 text-orange-400/70" />{car.fuel}
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-400">
                        <span className="text-orange-400/70 text-xs">★</span> {car.year}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {car.features.map((f) => (
                        ...
                        >
                          <CheckCircle2 className="h-3 w-3 text-orange-400/50 shrink-0" />
                          {f}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-white/5">
                    ...
                    <Button
                      asChild
                      size="lg"
                      className="bg-orange-500 hover:bg-orange-400 text-white font-bold rounded-xl px-6"
                    >
